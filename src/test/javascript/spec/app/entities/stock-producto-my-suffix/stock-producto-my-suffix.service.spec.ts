...
describe('Service Tests', () => {
    ...
    describe('StockProductoMySuffix Service', () => {
        ...
        beforeEach(() => {
            ...
            injector = getTestBed();
            service = injector.get(StockProductoMySuffixService);
        ...
        describe('Service methods', () => {
            it('should call correct URL', () => {
                ...
                const resourceUrl = SERVER_API_URL + 'api/stock-productos';
                expect(req.request.url).toEqual(resourceUrl + '/' + 123);
            });
            it('should return StockProductoMySuffix', () => {
