...
describe('Service Tests', () => {
    ...
    describe('MercadoMySuffix Service', () => {
        ...
        beforeEach(() => {
            ...
            injector = getTestBed();
            service = injector.get(MercadoMySuffixService);
        ...
        describe('Service methods', () => {
            it('should call correct URL', () => {
                ...
                const resourceUrl = SERVER_API_URL + 'api/mercados';
                expect(req.request.url).toEqual(resourceUrl + '/' + 123);
            });
            it('should return MercadoMySuffix', () => {
