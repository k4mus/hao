...
describe('Service Tests', () => {
    ...
    describe('RepartidorMySuffix Service', () => {
        ...
        beforeEach(() => {
            ...
            injector = getTestBed();
            service = injector.get(RepartidorMySuffixService);
        ...
        describe('Service methods', () => {
            it('should call correct URL', () => {
                ...
                const resourceUrl = SERVER_API_URL + 'api/repartidors';
                expect(req.request.url).toEqual(resourceUrl + '/' + 123);
            });
            it('should return RepartidorMySuffix', () => {
