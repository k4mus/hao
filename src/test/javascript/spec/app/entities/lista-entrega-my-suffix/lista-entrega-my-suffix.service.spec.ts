...
describe('Service Tests', () => {
    ...
    describe('ListaEntregaMySuffix Service', () => {
        ...
        beforeEach(() => {
            ...
            injector = getTestBed();
            service = injector.get(ListaEntregaMySuffixService);
        ...
        describe('Service methods', () => {
            it('should call correct URL', () => {
                ...
                const resourceUrl = SERVER_API_URL + 'api/lista-entregas';
                expect(req.request.url).toEqual(resourceUrl + '/' + 123);
            });
            it('should return ListaEntregaMySuffix', () => {
