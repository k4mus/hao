...
describe('Service Tests', () => {
    ...
    describe('CarroProductosMySuffix Service', () => {
        ...
        beforeEach(() => {
            ...
            injector = getTestBed();
            service = injector.get(CarroProductosMySuffixService);
        ...
        describe('Service methods', () => {
            it('should call correct URL', () => {
                ...
                const resourceUrl = SERVER_API_URL + 'api/carro-productos';
                expect(req.request.url).toEqual(resourceUrl + '/' + 123);
            });
            it('should return CarroProductosMySuffix', () => {
